    ...
    <div className="max-w-4xl mx-auto px-4 py-16 text-left">
      <Card hoverEffect={false} className="p-8 md:p-12 border border-white/10">
        ...
        <div className="bg-gold/10 border border-gold/20 p-4 rounded-xl mb-8 text-xs text-gold">
          <strong>DEMO POLICY NOTICE:</strong> This application is a client-side frontend prototype built for portfolio demonstration. Booking details and login sessions are cached locally on your device via <code className="bg-black/40 px-1 py-0.5 rounded">localStorage</code> and never sent to external servers.
        </div>
        ...
        <div className="space-y-6 text-gray-400 text-sm leading-relaxed">
          <section>
            ...
            <p>
              When you register or perform actions in this dashboard, the details (Full Name, Phone Number, Email, and Passwords) are committed to your browser's memory. We do not run any background logging API calls or track your browsing activity.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We utilize browser cookies or local web storage keys (<code className="text-white bg-white/5 px-1 py-0.5 rounded text-xs">almas_session</code> and <code className="text-white bg-white/5 px-1 py-0.5 rounded text-xs">almas_bookings</code>) strictly to preserve your active session and booking actions across tab refreshes.
            </p>
          </section>
